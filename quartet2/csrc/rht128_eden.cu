...
{
    if (N % 128 != 0) throw std::invalid_argument("rht128_eden: N must be divisible by 128");
    if (M % 128 != 0) throw std::invalid_argument("rht128_eden: M must be divisible by 128");
    CHECK_POINTER(y);
