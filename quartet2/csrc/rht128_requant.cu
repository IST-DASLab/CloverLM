...
{
    if (N % 128 != 0) throw std::invalid_argument("rht128_requant: N must be divisible by 128");
    if (M % 128 != 0) throw std::invalid_argument("rht128_requant: M must be divisible by 128");
    CHECK_POINTER(y);
